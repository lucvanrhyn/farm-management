...
describe("parseTursoRegion", () => {
  it("detects Tokyo (ap-northeast-1) from a legacy Turso URL", () => {
    const url =
      "libsql://trio-b-boerdery-lucvanrhyn.aws-ap-northeast-1.turso.io";
