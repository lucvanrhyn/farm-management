...
export default async function AdminPage({
  ...
  // Current month prefix for finance MTD query (e.g. "2026-03")
  const currentMonth = new Date().toISOString().slice(0, 7);

  // Fetch FarmSettings for configurable thresholds
