 ...
 *
 * Lifted from scripts/seed-basson-boerdery.ts (the 938-line hand-typed onboarding
 * for FarmTrack's first real client — every Afrikaans normalization and pedigree
 * resolution rule in this file was validated against Kobus Basson's spreadsheets).
 *
