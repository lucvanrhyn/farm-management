# Trio B Boerdery — Vercel Deployment
...
- `luc@triob.co.za` / `triob2024` (admin)
- `dicky@triob.co.za` / `triob2024` (field_logger)
- `oupa@triob.co.za` / `triob2024` (viewer)
...
5. Verify: visit `/login`, sign in with `oupa@triob.co.za` / `triob2024`
