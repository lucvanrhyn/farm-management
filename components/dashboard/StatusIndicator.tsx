...
const STATUS_STYLES: Record<string, { bg: string; text: string; border: string }> = {
  ...
  Fair:       { bg: "rgba(139,105,20,0.18)",  text: "var(--ft-fair)", border: "rgba(139,105,20,0.4)" },
  Poor:       { bg: "rgba(160,82,45,0.20)",   text: "var(--ft-poor)", border: "rgba(160,82,45,0.4)"  },
  Overgrazed: { bg: "rgba(139,58,58,0.22)",   text: "var(--ft-crit)", border: "rgba(139,58,58,0.45)" },
  Full:       { bg: "rgba(59,122,139,0.18)",  text: "#5AAFCA", border: "rgba(59,122,139,0.4)" },
  Low:        { bg: "rgba(139,105,20,0.18)",  text: "var(--ft-fair)", border: "rgba(139,105,20,0.4)" },
  Empty:      { bg: "rgba(160,82,45,0.20)",   text: "var(--ft-poor)", border: "rgba(160,82,45,0.4)"  },
  Broken:     { bg: "rgba(139,58,58,0.22)",   text: "var(--ft-crit)", border: "rgba(139,58,58,0.45)" },
  Intact:     { bg: "rgba(74,124,89,0.18)",   text: "#6FAB80", border: "rgba(74,124,89,0.4)"  },
  Damaged:    { bg: "rgba(139,58,58,0.22)",   text: "var(--ft-crit)", border: "rgba(139,58,58,0.45)" },
};
...
export default function StatusIndicator({ type, status, showIcon = true }: Props) {
  const s = STATUS_STYLES[status] ?? {
    bg: "rgba(92,61,46,0.18)", text: "var(--ft-subtle)", border: "rgba(92,61,46,0.4)",
  };
