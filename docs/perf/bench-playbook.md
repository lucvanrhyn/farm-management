...
|-------------------------------------|-------------|
| `/trio-b-boerdery/dashboard`        | Landing after login; renders SSR farm stats. |
| `/trio-b-boerdery/admin/animals`    | Biggest SSR page; pagination + Prisma fan-out. |
| `/trio-b-boerdery/logger`           | Heaviest client bundle; offline-logger shell. |
...
curl -s -H "Cookie: $BENCH_COOKIE" \
  https://farm-management-lilac.vercel.app/trio-b-boerdery/dashboard \
  >/dev/null
