 ...
 *   - /login                                  (public)
 *   - /trio-b-boerdery/home                   (first authed screen)
 *   - /trio-b-boerdery/dashboard              (heavy SSR)
 *   - /trio-b-boerdery/logger                 (logger fan-out)
 *   - /trio-b-boerdery/admin/animals          (SSR collection page)
 *
  ...
  ci: {
    collect: {
      url: [
        ...
        "http://localhost:3001/trio-b-boerdery/home",
        "http://localhost:3001/trio-b-boerdery/dashboard",
        "http://localhost:3001/trio-b-boerdery/logger",
        "http://localhost:3001/trio-b-boerdery/admin/animals",
      ],
      numberOfRuns: 3,
