 ...
 *   pnpm tsx scripts/migrate-farm-to-frankfurt.ts --slug trio-b-boerdery --dry-run
 *   pnpm tsx scripts/migrate-farm-to-frankfurt.ts --slug trio-b-boerdery
 *
 * Rollback (flips the meta-DB URL back to the previous value — the old Turso
 * DB must still exist):
 *   pnpm tsx scripts/migrate-farm-to-frankfurt.ts --slug trio-b-boerdery --rollback
 *
 * Safety properties:
