 ...
 * (basson-boerdery), so post-merge promote stops failing on them.
 *
 ...
 *
 * Strategy (full reset):
 *   1. Read basson-boerdery's sqlite_master DDL + _migrations rows
...
const SOURCE_TENANT = 'basson-boerdery';
