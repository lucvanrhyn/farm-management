/**
 * seed-acme-cattle.ts — Provision and populate Acme Cattle farm
 *
 * First FarmTrack client onboarding. Creates the farm DB, users, and imports
 * all data from Kobus Example's onboarding files.
 *
 * Prerequisites:
 ...
 *
 * Run:
 *   npx dotenv-cli -e .env.local -- npx tsx scripts/seed-acme-cattle.ts
 */
...
const FARM_SLUG = 'acme-cattle';
const FARM_NAME = 'Acme Cattle';
...
function buildTreatmentObservations(): ObsRecord[] {
  ...
  const individualTreatments: Array<{
    ...
    { date: '2025-10-02', tag: 'BB-C004', camp: 'siekboeg', treatmentType: 'Antibiotic', product: 'Penstrep 400', dose: '20ml IM', withdrawalDays: 28, loggedBy: 'kobus@example.com' },
    { date: '2025-10-02', tag: 'BB-C004', camp: 'siekboeg', treatmentType: 'Other', product: 'Finadyne', dose: '10ml IV', withdrawalDays: 5, loggedBy: 'kobus@example.com' },
    { date: '2025-10-08', tag: 'BB-X008', camp: 'siekboeg', treatmentType: 'Antibiotic', product: 'Penstrep 400', dose: '20ml IM', withdrawalDays: 28, loggedBy: 'kobus@example.com' },
    { date: '2025-10-08', tag: 'BB-X008', camp: 'siekboeg', treatmentType: 'Other', product: 'Finadyne', dose: '10ml IV', withdrawalDays: 5, loggedBy: 'kobus@example.com' },
    { date: '2025-10-28', tag: 'BB-X041', camp: 'siekboeg', treatmentType: 'Antibiotic', product: 'Terramycin LA', dose: '15ml IM', withdrawalDays: 21, loggedBy: 'kobus@example.com' },
    ...
    { date: '2025-11-19', tag: 'BB-C009', camp: 'siekboeg', treatmentType: 'Other', product: 'Estrumate', dose: '2ml IM', withdrawalDays: 3, loggedBy: 'kobus@example.com' },
    { date: '2025-12-15', tag: 'BB-B004', camp: 'bullekamp', treatmentType: 'Antibiotic', product: 'Penstrep 400', dose: '25ml IM', withdrawalDays: 28, loggedBy: 'kobus@example.com' },
    { date: '2026-01-22', tag: 'BB-H003', camp: 'rivierkamp', treatmentType: 'Deworming', product: 'Levamisole', dose: '10ml oral', withdrawalDays: 7, loggedBy: 'kobus@example.com' },
    { date: '2026-02-04', tag: 'BB-X019', camp: 'siekboeg', treatmentType: 'Antibiotic', product: 'Draxxin', dose: '12ml SC', withdrawalDays: 63, loggedBy: 'kobus@example.com' },
    { date: '2026-02-04', tag: 'BB-X019', camp: 'siekboeg', treatmentType: 'Other', product: 'Metacam', dose: '8ml IV', withdrawalDays: 10, loggedBy: 'kobus@example.com' },
  ];
...
async function provisionMetaRecords(farmDbUrl: string, farmDbToken: string): Promise<void> {
  ...
  console.log('  User: kobus.example (ADMIN)');

  await createUser(danieId, 'danie@example.com', 'danie.example', danieHash, 'Danie Example', true);
  console.log('  User: danie.example (ADMIN)');
