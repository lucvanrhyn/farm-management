...
// ── Animals sheet ────────────────────────────────────────────────────────────
const animalsData = [
  ["animal_id", "name", "sex", "date_of_birth", "breed", "category", "current_camp", "status", "mother_id", "father_id", "purchase_price", "notes", "date_added"],
  ["B-001", "Atlas",  "Male",   "2021-03-15", "Bonsmara", "Bull",   "Kraal",  "Active", "",      "",      45000, "Stud bull (bought)", "2024-01-10"],
  ["C-001", "Bella",  "Female", "2020-08-22", "Bonsmara", "Cow",    "Rivier", "Active", "C-050", "B-001", 12000, "Pregnant (bought)",  "2024-01-10"],
  ["H-001", "",       "Female", "2023-06-10", "Bonsmara", "Heifer", "Koppie", "Active", "C-001", "B-001", "",    "Home-bred — leave blank", "2024-06-10"],
  ["K-001", "",       "Male",   "2025-09-15", "Bonsmara", "Calf",   "Rivier", "Active", "C-001", "B-001", "",    "Born on farm",       "2025-09-15"],
  ["O-001", "",       "Male",   "2021-11-03", "Bonsmara", "Ox",     "Koppie", "Active", "",      "",      9000,  "Castrated 2022",     "2024-03-01"],
];
const animalsWidths = [10, 10, 8, 14, 10, 10, 14, 10, 10, 10, 14, 22, 12];
...
(async () => {
  ...
  console.log("  Sheet 2: Animals (13 columns, 5 example rows)");
})().catch((err) => {
  console.error(err);
  process.exit(1);
});
