 ...
 *   1. Login as trio-b-boerdery Advanced admin.
 *   2. Navigate to /trio-b-boerdery/admin/einstein.
 ...
 *   8. Navigate to /trio-b-boerdery/admin/settings/ai → rename box visible,
 ...
 *   - The trio-b-boerdery tenant DB migrated with Phase L schema (Wave 4)
...
// ── Step 1: Login ─────────────────────────────────────────────────────────────
test.skip('Step 1 — login as trio-b-boerdery Advanced admin', async () => {
...
//    npx tsx scripts/migrate-phase-l-einstein.ts trio-b-boerdery
//    npx tsx scripts/backfill-phase-l-embeddings.ts trio-b-boerdery
//
