...
**Live baseline:** `main @ 426d98e` — demo-safe, 1 paying tenant (`acme-cattle`), 0 outages tolerated

---

## Problem Statement

Luc is a non-technical founder running FarmTrack as a multi-tenant SaaS for South African farmers. He has one paying tenant (acme-cattle, 103 cattle) and is preparing to onboard more. Three problems are blocking him from confidently shipping:
