...
Optional repo variable: `BRANCH_CLONE_SOURCE_DB` — defaults to `acme-cattle` in the workflow.
...
gh secret set PROD_TENANT_DB_URL --body "libsql://acme-cattle.turso.io"
gh secret set PROD_TENANT_DB_AUTH_TOKEN --body "<token>"
gh variable set BRANCH_CLONE_SOURCE_DB --body "acme-cattle"
```
...
export PROD_TENANT_DB_URL="libsql://acme-cattle.turso.io"
