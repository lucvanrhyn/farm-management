...
export const config = {
  matcher: [
    "/((?!login|register|verify-email|subscribe|api/auth|api/inngest|api/einstein|api/observations|api/webhooks|offline|_next/static|_next/image|favicon\\.ico|manifest\\.json|brangus\\.jpg|sw\\.js|.*\\.png|.*\\.jpg|.*\\.ico).*)",
  ],
};
